...
{
  UInt32 level = GetLevel2();
  UInt32 methodID = GetMethodID();
  static UInt32 methodIDPrev = 0;

  ShowInfo(L"SetMethod level=%d method=%d methodPrev=%d", GetLevel(), methodID, methodIDPrev);
  if (methodID != methodIDPrev) {
    methodIDPrev = methodID;
    SetLevel();
  }
